...
export default function ImtiPage() {
  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-zinc-950">
      ...
      <div className="h-10 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-center gap-3 px-4">
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {chatMessages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[70%] rounded-lg px-4 py-2 ${msg.role === 'user' ? 'bg-blue-600 text-white' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white'}`}>
