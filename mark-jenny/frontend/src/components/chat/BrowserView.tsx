          ...
          {messages.length === 0 ? (
            ...
            messages.map((msg) => (
              <div key={msg.id} className={cn("flex", msg.role === "USER" ? "justify-end" : "justify-start")}>
                <div className={cn("max-w-[85%] rounded-lg px-3 py-2 text-sm", msg.role === "USER" ? "bg-sky-600 dark:bg-sky-600 text-white font-semibold shadow-sm shadow-sky-600/25" : "bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-zinc-100")}>
