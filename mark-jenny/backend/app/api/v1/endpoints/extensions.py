...
@router.get("/extensions/types")
async def list_extension_types():
    return {"types": extension_manager.EXTENSION_TYPES}
...
@router.post("/extensions/install-url")
...
@router.post("/extensions/install-github")
...
@router.post("/extensions/install-skill")
...
@router.post("/extensions/install-model")
...
@router.get("/extensions/discover/auto")
