...
@router.get("/self-build/{session_id}")
...
@router.get("/self-build/{session_id}/logs")
...
@router.get("/self-build/{session_id}/files")
...
@router.post("/self-build/{session_id}/integrate")
...
@router.post("/self-build/{session_id}/rollback")
...
@router.websocket("/self-build/ws/{session_id}")
