                    ...
                    editing ? (
                      ...
                      <>
                        <div
                          ...
                          className="cursor-pointer rounded-2xl bg-sky-700 dark:bg-sky-700 px-4 py-3 text-sm whitespace-pre-wrap break-words text-white shadow-sm shadow-sky-700/25"
                        >
                          {m.content || ""}
                        </div>
                        {menuOpen && (
