          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            {chatMessages.map((msg, i) => (
              <div key={i} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-[70%] rounded-lg px-4 py-2 ${msg.role === 'user' ? 'bg-sky-600 dark:bg-sky-600 text-white font-semibold shadow-sm shadow-sky-600/25' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-900 dark:text-white'}`}>
